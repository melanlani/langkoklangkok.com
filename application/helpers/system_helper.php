...
if(!function_exists('user_info'))
{
	function user_info($user)
	{
		...
		$item=$CI->model_users->akun_member($user);
		return $item;
	}
}

if(!function_exists('user_infoo'))
{
	function user_infoo($output='userid')
	{
		$CI=& get_instance();
		$CI->load->model('model_users');
		$item=$CI->model_users->akun_member($output);
		return $item;
	}
}
...
if(!function_exists('roleid'))
{
	function roleid()
	{
		$CI=& get_instance();
		$CI->load->model('model_users');
		$item=$CI->model_users->akun_member('roleid');
		return $item;
	}
}
...
if(!function_exists('user_photo'))
{
	function user_photo()
	{
		$CI=& get_instance();
		$CI->load->model('model_users');
		$item=$CI->model_users->user_photo();
		return $item;
	}
}
