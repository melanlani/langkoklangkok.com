			...
			<div class="col-md-4">
				<div class="panel panel-info">
					...
					<br>
						...
						echo form_open(site_url('kategori_resep/edit'));
						?>
						<input type="hidden" name="kategoriid" value="<?=$row->id_masakan;?>" required=""/>
						<div class="form-group row">
									<p class="col-sm-4 form-control-label">Nama Kategori *</p>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="nama" placeholder="Nama Kategori" value="<?=set_value('nama',$row->negara);?>"/>
									</div>
								</div>	
						<div class="form-group row">
									<div class="col-sm-4">
