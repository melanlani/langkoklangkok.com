            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="panel panel-info">
						...
						echo form_open(site_url('order/shipping_pelapak'),array('class'=>'form-horizontal'));
						?>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<button type="submit" onclick="return confirm('Yakin telah mengirim orderan ini?');" class="btn btn-primary btn-flat">Saya telah memaketkan barang kepada kurir</button>
