        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    echo form_open_multipart(site_url('produk/edit'),array('class'=>'form-horizontal'));
                    ?>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="">Resep Masakan</label>
                            <div class="col-md-10">
                                <select name="bumburesep" id="bumburesep" class="form-control" required="" style="width: 100%">
